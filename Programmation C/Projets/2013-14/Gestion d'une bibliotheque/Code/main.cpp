...
int main()
{
    char mot_de_passe [20]; /// Stocke le mot de passe
    char mdp_biblio [] = "biblio"; /// Les chaînes mdps définies
    ...
    printf("Avant toute chose par mesure de precaution, \n ne pas utiliser la touche <espace> mais mettre <_> !");
    printf("\n");
    printf("\n");
    ...
    do
    {
        ...
        mdp = (char*)malloc(sizeof(char) * (length + 1));
